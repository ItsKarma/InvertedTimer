...
export default function Home() {
				...
				<div className={styles.timerSmallContainer}>
					...
					<div>
						<h1 className={styles.timerSmall}>
							{desiredRestMinutes < 10 ? `0${desiredRestMinutes}` : desiredRestMinutes}:
							{desiredRestSeconds < 10 ? `0${desiredRestSeconds}` : desiredRestSeconds}
						</h1>
					</div>
					{!isRunning && !isResting && (
						<div className={styles.iconButtonWrapper}>
	...
	return (
		...
		<div className={isRunning ? styles.running : isResting ? styles.resting : styles.default}>
			<Head>
